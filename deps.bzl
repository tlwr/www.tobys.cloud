...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:oXAz+Vh0PMUvJczoi+flxpnBEPxoER1IaAnU/NMPtT0=",
        version = "v1.17.10",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_phyber_negroni_gzip",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/phyber/negroni-gzip",
        sum = "h1:ru1uBeaUeoAXYgZRE7RsH7ftj/t5v/hkufXv1OYbNK8=",
        version = "v1.0.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_zbindenren_negroni_prometheus",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/zbindenren/negroni-prometheus",
        sum = "h1:zF5HJf47Wfc+7NaQuz2z2xq367iaWDbhLLABm0uo1bc=",
        version = "v0.1.1",
    )
    go_repository(
